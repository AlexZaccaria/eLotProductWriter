...
<html>
   ...
   <body>
      <?php
         if ($debug)
         { echo ("<form action='/v2/writer.php?t=t002' method='post'>"); }
      ?>
      <div align="center">
         <blockquote>
            <blockquote>
               <table border="0" width="90%">
                  <tbody>
                     <tr>
                        <td align="center"><img src="/v2/statics/t002/top.jpg" alt="" height="266" width="850"></td>
                     </tr>
                     <tr>
                        <td align="center">
                           ...
                           <p><img src="/v2/statics/t002/divider.jpg" alt="" height="42" width="367"><br></p>
                           <table bordercolorlight="#858585" bordercolordark="#ebebeb" background="/v2/statics/t002/background1.jpg" border="1" cellpadding="8" cellspacing="0" width="730">
                              <tbody>
                                 <tr>
                                    <td height="48" width="94%">
                                       <div align="center">
                                          <center>
                                             <table bordercolorlight="#858585" bordercolordark="#ebebeb" background="/v2/statics/t002/background2.jpg" border="1" cellpadding="3" cellspacing="0" width="100%">
                                                <tbody>
                                                   <tr>
                                                      <td height="28">
                                                         <div align="center">
                                                            <center>
                                                               <table bordercolorlight="#858585" bordercolordark="#ebebeb" background="/v2/statics/t002/background1.jpg" border="1" cellpadding="0" cellspacing="3">
                                                                  <tbody>
                                                                     <?php if (empty($file)) : ?>
                                                                        <tr>
                           ...
                           <p><br></p>
                           <p><img src="/v2/statics/t002/divider.jpg" alt="" height="42" width="367"></p>
                           ...
                           <table border="0" width="100%">
                              <tbody>
                                 <tr>
                                    ...
                                    <td align="right" width="31%"><img src="/v2/statics/t002/firma.png" alt="" height="250" width="343"></td>
                                 </tr>
                              </tbody>
                           </table>
                        </td>
    ...
    <audio autoplay loop>
      <source src="/v2/statics/t002/musica.mp3" type="audio/mpeg">
    </audio>
   <?php if ($debug) : ?>
      <center>
         <hr>
